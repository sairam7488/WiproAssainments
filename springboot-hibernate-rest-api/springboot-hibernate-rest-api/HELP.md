...
* The original package name 'com.example.restapi.springboot-hibernate-rest-api' is invalid and this project uses 'com.example.restapi.springboot_hibernate_rest_api' instead.
